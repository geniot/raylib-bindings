...
export const lib = Deno.dlopen(
  "./lib/libraylib_" + Deno.build.arch + "." + librarySuffix(),
  {
    ...
    LoadFontData: {
      parameters: ["pointer", "i32", "i32", "pointer", "i32", "i32", "pointer"],
      result: "pointer",
    },
    ...
    IsMusicValid: { parameters: ["buffer"], result: "u8" },
    IsWaveValid: { parameters: ["buffer"], result: "u8" },
    IsSoundValid: { parameters: ["buffer"], result: "u8" },
    IsMusicStreamPlaying: { parameters: ["buffer"], result: "u8" },
    IsSoundPlaying: { parameters: ["buffer"], result: "u8" },
    UpdateMusicStream: { parameters: ["buffer"], result: "u8" },
    UpdateSound: { parameters: ["buffer","pointer","i32"], result: "u8" },
    StopMusicStream: { parameters: ["buffer"], result: "u8" },
    PauseMusicStream: { parameters: ["buffer"], result: "u8" },
    ResumeMusicStream: { parameters: ["buffer"], result: "u8" },
    SeekMusicStream: { parameters: ["buffer", "i32"], result: "i32" },
    UnloadMusicStream: { parameters: ["buffer"], result: "u8" },
    UnloadWave: { parameters: ["buffer"], result: "u8" },
    UnloadSound: { parameters: ["buffer"], result: "u8" },
    UnloadSoundAlias: { parameters: ["buffer"], result: "u8" },
    PlaySound: { parameters: ["buffer"], result: "u8" },
    StopSound: { parameters: ["buffer"], result: "u8" },
    PauseSound: { parameters: ["buffer"], result: "u8" },
    ResumeSound: { parameters: ["buffer"], result: "u8" },
    ...
    LoadWaveSamples: { parameters: ["buffer"], result: "pointer" },
    LoadSound: { parameters: ["buffer"],       result: {
        "struct": ["u8", "f32", "f32", "f32", "f32", "f32", "f32", "f32"],
      }, },
    LoadSoundFromWave: { parameters: ["buffer"],       result: {
        "struct": ["u8", "f32", "f32", "f32", "f32", "f32", "f32", "f32"],
      }, },
    LoadSoundAlias: { parameters: ["buffer"],       result: {
        "struct": ["u8", "f32", "f32", "f32", "f32", "f32", "f32", "f32"],
      }, },
    ...
    PlayMusicStream: { parameters: ["buffer"], result: "u8" },
    LoadWave: {
      parameters: ["buffer"],
      result: {
        "struct": ["u8", "f32", "f32", "f32", "f32", "f32", "f32", "f32"],
